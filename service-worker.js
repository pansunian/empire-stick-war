const CACHE_NAME = "stick-war-pwa-v150";
const APP_SHELL = [
  "./",
  "./index.html",
  "./style.css?v=20260614-element-stagger-fix",
  "./game.js?v=20260614-element-stagger-fix",
  "./manifest.webmanifest?v=20260614-element-stagger-fix",
  "./assets/icon.svg",
