const CACHE_NAME = "stick-war-pwa-v146";
const APP_SHELL = [
  "./",
  "./index.html",
  "./style.css?v=20260614-command-order-restore",
  "./game.js?v=20260614-command-order-restore",
  "./manifest.webmanifest?v=20260614-command-order-restore",
  "./assets/icon.svg",
