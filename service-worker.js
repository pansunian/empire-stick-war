const CACHE_NAME = "stick-war-pwa-v110";
const APP_SHELL = [
  "./",
  "./index.html",
  "./style.css?v=20260613-mode-scroll-fix",
  "./game.js?v=20260613-mode-scroll-fix",
  "./manifest.webmanifest?v=20260613-mode-scroll-fix",
  "./assets/icon.svg",
