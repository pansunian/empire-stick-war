const CACHE_NAME = "stick-war-pwa-v126";
const APP_SHELL = [
  "./",
  "./index.html",
  "./style.css?v=20260613-fourway-summon-skills",
  "./game.js?v=20260613-fourway-summon-skills",
  "./manifest.webmanifest?v=20260613-fourway-summon-skills",
  "./assets/icon.svg",
