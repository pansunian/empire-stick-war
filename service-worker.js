const CACHE_NAME = "stick-war-pwa-v142";
const APP_SHELL = [
  "./",
  "./index.html",
  "./style.css?v=20260614-home-start-visible",
  "./game.js?v=20260614-home-start-visible",
  "./manifest.webmanifest?v=20260614-home-start-visible",
  "./assets/icon.svg",
