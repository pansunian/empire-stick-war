const CACHE_NAME = "stick-war-pwa-v117";
const APP_SHELL = [
  "./",
  "./index.html",
  "./style.css?v=20260613-fourway-3000x1800",
  "./game.js?v=20260613-fourway-3000x1800",
  "./manifest.webmanifest?v=20260613-fourway-3000x1800",
  "./assets/icon.svg",
