const CACHE_NAME = "stick-war-pwa-v119";
const APP_SHELL = [
  "./",
  "./index.html",
  "./style.css?v=20260613-balance-baseline",
  "./game.js?v=20260613-balance-baseline",
  "./manifest.webmanifest?v=20260613-balance-baseline",
  "./assets/icon.svg",
