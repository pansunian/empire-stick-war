const CACHE_NAME = "stick-war-pwa-v109";
const APP_SHELL = [
  "./",
  "./index.html",
  "./style.css?v=20260613-fourway-player-control",
  "./game.js?v=20260613-fourway-player-control",
  "./manifest.webmanifest?v=20260613-fourway-player-control",
  "./assets/icon.svg",
