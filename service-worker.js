const CACHE_NAME = "stick-war-pwa-v153";
const APP_SHELL = [
  "./",
  "./index.html",
  "./style.css?v=20260614-undead-element-traits",
  "./game.js?v=20260614-undead-element-traits",
  "./manifest.webmanifest?v=20260614-undead-element-traits",
  "./assets/icon.svg",
