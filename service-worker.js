const CACHE_NAME = "stick-war-pwa-v152";
const APP_SHELL = [
  "./",
  "./index.html",
  "./style.css?v=20260614-element-skill-trim",
  "./game.js?v=20260614-element-skill-trim",
  "./manifest.webmanifest?v=20260614-element-skill-trim",
  "./assets/icon.svg",
