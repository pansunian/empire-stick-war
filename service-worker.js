const CACHE_NAME = "stick-war-pwa-v143";
const APP_SHELL = [
  "./",
  "./index.html",
  "./style.css?v=20260614-order-price-update",
  "./game.js?v=20260614-order-price-update",
  "./manifest.webmanifest?v=20260614-order-price-update",
  "./assets/icon.svg",
