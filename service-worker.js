const CACHE_NAME = "stick-war-pwa-v115";
const APP_SHELL = [
  "./",
  "./index.html",
  "./style.css?v=20260613-faction-balance",
  "./game.js?v=20260613-faction-balance",
  "./manifest.webmanifest?v=20260613-faction-balance",
  "./assets/icon.svg",
