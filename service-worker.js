const CACHE_NAME = "stick-war-pwa-v127";
const APP_SHELL = [
  "./",
  "./index.html",
  "./style.css?v=20260613-v-control-blocklist",
  "./game.js?v=20260613-v-control-blocklist",
  "./manifest.webmanifest?v=20260613-v-control-blocklist",
  "./assets/icon.svg",
