const CACHE_NAME = "stick-war-pwa-v151";
const APP_SHELL = [
  "./",
  "./index.html",
  "./style.css?v=20260614-mode-faction-sweep",
  "./game.js?v=20260614-mode-faction-sweep",
  "./manifest.webmanifest?v=20260614-mode-faction-sweep",
  "./assets/icon.svg",
