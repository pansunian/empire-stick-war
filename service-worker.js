const CACHE_NAME = "stick-war-pwa-v120";
const APP_SHELL = [
  "./",
  "./index.html",
  "./style.css?v=20260613-rocketcart-reload",
  "./game.js?v=20260613-rocketcart-reload",
  "./manifest.webmanifest?v=20260613-rocketcart-reload",
  "./assets/icon.svg",
