const CACHE_NAME = "stick-war-pwa-v125";
const APP_SHELL = [
  "./",
  "./index.html",
  "./style.css?v=20260613-order-extra-archer",
  "./game.js?v=20260613-order-extra-archer",
  "./manifest.webmanifest?v=20260613-order-extra-archer",
  "./assets/icon.svg",
